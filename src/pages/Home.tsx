...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-4 justify-center items-center min-h-full">
      ...
      <div className="card glass p-4 shadow bg-slate-800/80 hover:bg-slate-900/80 rounded border-slate-500 border w-[512px] max-w-[90vw] mx-4 text-white flex flex-col gap-4">
      ...
      <div className="card mt-auto glass p-4 shadow bg-slate-800/80 hover:bg-slate-900/80 rounded border-slate-500 border w-[512px] max-w-[90vw] mx-4 text-white flex flex-col items-center">
